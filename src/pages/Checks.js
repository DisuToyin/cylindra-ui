...
const TABLE_HEAD = [
  ...
  { id: 'role', label: 'SSL', alignRight: false },
...
export default function Checks() {
  ...
  const handleNavigationToSinglePage = (id) => {
    console.log(`clicks... ${id}`);
    navigate(`/dashboard/check/${id}`);
  };
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">
                          <Label color={(status === false && 'error') || 'success'}>Down</Label>
                        </TableCell>
